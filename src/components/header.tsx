...
export default function Header (){
    return(
            <Grid as="nav" templateColumns='repeat(6, 1fr)' className="items-center mb-4">
                    ...
                    <GridItem colStart={{base: '3', md: '4'}} colEnd={7} className="hidden md:block">
                        <List className="fixed md:absolute w-[100%] md:w-[50%] top-0 right-0 z-50 h-[100vh] md:flex justify-between text-sm">
                            <svg className="md:hidden" width="32" height="31" xmlns="http://www.w3.org/2000/svg"><g fill="#00001A" fill-rule="evenodd"><path d="m2.919.297 28.284 28.284-2.122 2.122L.797 2.419z"/><path d="M.797 28.581 29.081.297l2.122 2.122L2.919 30.703z"/></g></svg>
                            <ListItem><Link href='#' className="hover:text-red-600">Home</Link></ListItem>
                            <ListItem><Link href='#' className="hover:text-red-600">New</Link></ListItem>
                            <ListItem><Link href='#' className="hover:text-red-600">Popular</Link></ListItem>
                            <ListItem><Link href='#' className="hover:text-red-600">Trending</Link></ListItem>
                            <ListItem><Link href='#' className="hover:text-red-600">Category</Link></ListItem>
                        </List>
                    </GridItem>
